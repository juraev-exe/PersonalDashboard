...
import { Moon, Star, Check, Flame, Calendar, Info, Clock, Sun } from 'lucide-react';
...
export default function PrayersPage() {
  ...
  const prayerIcons: Record<PrayerName, typeof Moon> = {
    [PrayerName.FAJR]: Star,
    [PrayerName.DHUHR]: Sun,
    [PrayerName.ASR]: Clock,
    [PrayerName.MAGHRIB]: Calendar,
      ...
      <div className="glass-card" style={{ padding: '24px', display: 'flex', flexWrap: 'wrap', gap: 24, alignItems: 'center' }}>
        <div style={{ flex: '1 1 200px' }}>
          ...
          <p style={{ fontSize: 13, color: 'var(--color-text-muted)', marginBottom: 16 }}>
            {todayProgress === 100 ? "All 5 prayers completed today." : todayProgress > 0 ? "Progress logged. Keep going." : "Track your prayers to build your daily routines."}
          </p>
